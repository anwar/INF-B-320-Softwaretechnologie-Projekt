...
|Hauptpächter            |Ein Hauptpächter ist ein User. Er kann einen Konflikt zwischen Pächter melden, kann einen Termin für Pflichtstunde festlegen und kann seinen Mietvertrag kündigen.             |
|Nebenpächter            |Ein Nebenpächter ist ein User. Er kann einen Konflikt zwischen Pächter melden und kann einen Termin für Pflichtstunde festlegen             |
|Vorstand                |…            |
|Protokollant            |…            |
|Stellvertreter          |Ein Stellenvertreter ist ein Haupt- oder Nebenpächter, aber er hat mehrere zusätzliche Funktionen. Die folgende Funktionen sind: Bewerbung bearbeiten, einen Mietvertrag kündigen, Ermahnung und Preise ändern.            |
|Schatzmeister           |Ein Schatzmeister ist ein Haupt- oder Nebenpächter und er hat eine zusätzliche Preise-Änderung Funktion.           |
|Obmann                  |…            |
|Vorstandvorsitzender    |Ein Vorstandvorsitzender ist ein Haupt- oder Nebenpächter, aber er hat mehrere zusätzliche Funktionen. Die folgende Funktionen sind: Bewerbung bearbeiten, einen Mietvertrag kündigen, Ermahnung und Preise ändern.             |
...
|Termin                  |Die Termin-Klasse bearbeite jährliche 8 Termine von Pflichtstunde. Hier kann Haupt-/Nebenpächter seine Termin anmelden und Obmänner werden darüber informiert.            |
|Pflichtstunde           |…            |
