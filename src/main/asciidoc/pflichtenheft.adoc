...
|PÄCHTER                 |Jeder Pächter ist einer Rolle zugeordnet, wodurch gewisse Zugriffsrechte auf die Anwendung. (Haupt-/Nebenpächter)             |
|Vorstand                |…            |
|Protokollant            |…            |
|Stellvertreter          |Ein Stellenvertreter ist ein Pächter, aber er hat mehrere zusätzliche Funktionen. Die folgende Funktionen sind: Bewerbung bearbeiten, einen Mietvertrag kündigen, Ermahnung und Preise ändern.            |
|Schatzmeister           |Ein Schatzmeister ist ein Pächter und er hat eine zusätzliche Preise-Änderung Funktion.           |
|Obmann                  |…            |
|Vorstandvorsitzender    |Ein Vorstandvorsitzender ist ein Pächter, aber er hat mehrere zusätzliche Funktionen. Die folgende Funktionen sind: Bewerbung bearbeiten, einen Mietvertrag kündigen, Ermahnung und Preise ändern.             |
...
|BEWERBUNG/Bewerbung     |(Angenommen, gelöscht, neu und bearbeitet)              |
