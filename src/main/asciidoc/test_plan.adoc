...
|**<<AT0011>>**
|**<<UC0010>>**
|Bewerbungen für eine Parzelle ansehen
|Nutzer hat Rolle Obmann
|Model mit Parzelle
|Model mit Bewerbungen
...
|Jahr, Parzelle, Wasserzählerstand
...
|Hinzufügen des Wasserzählerstands
|--
|Form mit Wasserzählerstand, Parzelle
|Model mit Jahr, Parzelle und Wasserzählerstand
...
|Jahr, Parzelle, Elektrozählerstand
...
|**<<AT0030>>**
|**<<UC0030>>**
|Hinzufügen des Elektrozählerstands
|--
|Form mit Elektrozählerstand, Parzelle
|Model mit Jahr, Parzelle und Elektrozählerstand
...
|===
|ID |Anwendungsfall |Vorbedingungen |Eingabe |Ausgabe
|F-I-003  |Rechnen Wasserkosten einer Parzelle      |Wasserzählerstand einer Parzelle      |Wasserzählerstand (und Wasserkosten pro Kubikmeter)  |Ein Preis von Wasserkost einer Parzelle wird gerechnet
|F-I-005  |Rechnen Stromkosten einer Parzelle       |Stromzählerstand einer Parzelle       |Stromzählerstand (und Stromkosten pro Kilowatt)      |Ein Preis von Stromkost einer Parzelle wird gerechnet
|F-I-007  |Rechnen Miete einer Parzelle             |Größe einer Parzelle                  |Größe der Parzelle (und Miete pro Quadratmeter)      |Eine jährliche Miete der Parzelle wird gerechnet
|F-I-015  |Schätzen fehlender Rechnungspositionen   |Rechnung existiert, alle bekannten Positionen sind angelegt  |Alle Positionen  |Fehlende Kosten oder Verbräuche werden geschätzt
...
|F-I-023  |Erstellen eine jährliche Rechnung in PDF         |Rechnung ist erstellt         |Button                |Eine jährliche Rechnung der Parzelle wird in PDF erstellt
|F-I-030  |Versenden per E-Mail  |Rechnung ist erstellt     |Adressat und PDF  |Die Rechnung wird dem Empfänger zugestellt
|===
