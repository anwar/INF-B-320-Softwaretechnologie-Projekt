...
|F-U-003 |Positionen löschen  |Position existert  |Bestätigung  |Rechnungspositionen werden gelöscht   
...
| M-I-020 | Nachricht ist ordnungsgemäß geschickt |                                                                  | Nachricht         | erfolgreich Assertion Test durch E-mail Test Server (https://asciidoctor.org[GreenMail])
|===
