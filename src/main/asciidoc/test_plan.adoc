...
|F-I-002 |Positionen generieren  |Vorgang(Procedure) existiert  |Button  |Rechnungspositionen werden aus dem Vorgang generiert  | Fehlermeldung erscheint, dass ein Pächter nur deaktiviert werden kann, wenn für seine Parzelle ein Nachpächter bestimmt ist
...
|===
|ID |Anwendungsfall |Vorbedingungen |Eingabe |Ausgabe
|F-I-001  |eine neue Rechnungsposition hinzufügen    |--                                                |Name, Preis und Menge von einer Position            |Die neue Position wird erstellt
|F-I-002 |Positionen generieren  |Vorgang(Procedure) existiert  |Button  |Rechnungspositionen werden aus dem Vorgang generiert  
|F-I-003 |Positionen löschen  |Position existert  |Bestätigung  |Rechnungspositionen werden gelöscht   
|F-I-005  |eine Rechnungsposition bearbeiten        |Position existiert in Preisliste            |Name, Preis oder Menge von einen Position           |Die gewählte Position enthält einen neuen Wert
|F-I-010  |Rechnen Wasserkosten einer Parzelle              |Wasserzählerstand einer Parzelle                  |Wasserzählerstand (und Wasserkosten pro Kubikmeter)     |Ein Preis von Wasserkost einer Parzelle wird gerechnet
...
|F-I-019 |Schätzen fehlender Rechnungspositionen  |Rechnung existiert, alle bekannten Positionen sind angelegt  |Alle Positionen  |Fehlende Kosten oder Verbräuche werden geschätzt
