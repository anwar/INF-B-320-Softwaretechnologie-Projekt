...
wem sie gestellt wurden und was die Gründe waren. Nachdem er abseits der Software um diese gekümmert hat, kann er
ihren Status auf "FINISHED" setzen, um die Abarbeitung der Beschwerde zu verdeutlichen. Dies kann auch der Nutzer sehen,
der die Beschwerde verfasste. Ihm obliegt auch die Möglichkeit Beschwerden zu löschen. 
