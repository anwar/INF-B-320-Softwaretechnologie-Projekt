...
=== Pächterverwaltung
image::models/analysis/KleinGartenAnlage.tenant.png[Pächterverwaltung]
...
|PlotService
|Managementklasse, beinhaltet Methoden, die vom Controller genutzt werden, um diesen übersichtlich zu halten
