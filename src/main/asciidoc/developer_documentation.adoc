...
|FeeController
|Die FeeController Klasse ist verantworlich für die Aufrufe der verschiedene (Html) Seiten

|FeeManagement
|Die FeeManagement Klasse ist verantworlich für die Verwaltung der Preisliste
