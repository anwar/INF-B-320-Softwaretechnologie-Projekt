...
public class Application {
	...
	CommandLineRunner init(GuestbookRepository guestbook) {
		...
		return args -> {
			...
			Stream.of( //
					new GuestbookEntry("H4xx0r", "H4xxor@bsp.com", "first!!!"), //
					new GuestbookEntry("Arni", "Arni55@bsp.com", "Hasta la vista, baby"), //
					new GuestbookEntry("Duke Nukem", "Duke_Nukem@bsp.com","It's time to kick ass and chew bubble gum. And I'm all out of gum."), //
