...
class GuestbookEntryUnitTests {
	...
	void rejectsEmptyName() {
		...
		assertThatExceptionOfType(IllegalArgumentException.class)//
				.isThrownBy(() -> new GuestbookEntry("", "May the 4th be with you!", "Dresden"));
	}
	...
	void rejectsEmptyText() {
		...
		assertThatExceptionOfType(IllegalArgumentException.class)//
				.isThrownBy(() -> new GuestbookEntry("Ollie", "", "Dresden"));
	}
	...
	void setsCreationDate() {
		assertThat(new GuestbookEntry("Ollie", "May the 4th be with you!", "Dresden").getDate()).isNotNull();
	}
}
